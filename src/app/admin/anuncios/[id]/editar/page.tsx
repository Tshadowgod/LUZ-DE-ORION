...
export default async function AdminEditarAnuncioPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="liquid-glass glossy-reflection rounded-[2.5rem] p-8 animate-scale-in">
        <p className="text-[11px] font-bold tracking-[0.2em] text-tertiary font-sans uppercase mb-1">EDITAR AVISO</p>
        <h2 className="font-display text-2xl font-semibold text-on-background mb-6">{item.title}</h2>
        <AnnouncementForm mode="edit" announcementId={item.id} placement="popup" backHref="/admin/anuncios"
