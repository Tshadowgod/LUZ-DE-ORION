  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-2 mb-8 text-sm font-sans animate-fade-in">
        <Link href="/admin/catalogo" className="text-on-surface-variant/60 hover:text-primary hover:-translate-x-0.5 transition-all inline-block">← Catálogo</Link>
      ...
      <div className="liquid-glass glossy-reflection rounded-[2.5rem] p-8 animate-scale-in">
        ...
        <ProductForm categories={cats} mode="create" redirectTo="/admin/catalogo" />
      </div>
    </div>
  );
}
